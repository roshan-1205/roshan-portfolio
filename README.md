...
- **Interactive 3D Elements** - React Three Fiber powered hero section
...
1. **Hero** - Introduction with animated photo
2. **About** - Personal bio and highlights
3. **Skills** - Technical expertise with progress bars
4. **Projects** - Featured work with live demos
5. **Timeline** - Journey and achievements
