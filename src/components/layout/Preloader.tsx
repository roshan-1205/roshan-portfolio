...
export function Preloader({ onComplete }: PreloaderProps) {
  ...
  const [phase, setPhase] = useState<"scan" | "complete" | "exit">("scan")
  ...
  useEffect(() => {
    ...
    const tick = (now: number) => {
      ...
      window.setTimeout(() => setPhase("complete"), 300)
    }
    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          {phase === "scan" && (
            <motion.div
              className={loadingScreenPositionClass}
          ...
          {phase === "complete" && (
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <motion.p
                  className="mt-8 font-mono-ui text-[10px] tracking-[0.4em] text-cyan/70 uppercase"
