...
import ScrollAnimations, { StaggerContainer } from './ScrollAnimations';
...
const About = () => {
  ...
  return (
    <section id="about" ref={ref} className="py-section bg-lightAccent/10 relative overflow-hidden">
      <div className="max-w-container mx-auto px-8">
        <ScrollAnimations animationType="fadeUp">
          <motion.div
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <ScrollAnimations animationType="fadeRight">
            <motion.div
            ...
            >
              <Card3D intensity={0.12} scale={1.03} glowEffect={true}>
                <div className="relative w-full max-w-md mx-auto">
                  ...
                  >
                    <div className="bg-white/80 backdrop-blur-sm rounded-[2.5rem] p-3">
                      <img
          ...
          <ScrollAnimations animationType="fadeLeft">
            ...
            >
              ...
              <StaggerContainer className="grid gap-4 pt-4" staggerDelay={0.1}>
                {features.map((feature, index) => (
                  <Card3D key={feature.title} intensity={0.08} scale={1.02}>
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                      animate={isInView ? { opacity: 1, y: 0 } : {}}
                      transition={{ duration: 0.5, delay: 0.4 + index * 0.1 }}
                      whileHover={{ scale: 1.02, translateX: 10 }}
                      className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg flex items-start gap-4 cursor-pointer"
                    >
